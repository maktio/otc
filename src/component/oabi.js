...
const abiJson = [{"inputs": [], "stateMutability": "nonpayable", "type": "constructor"}, {
    "anonymous": false,
    "inputs": [{"indexed": false, "internalType": "bytes32", "name": "token", "type": "bytes32"}, {
        "indexed": false,
    ...
    "inputs": [{"internalType": "bytes32", "name": "hcode", "type": "bytes32"}, {
        ...
        "name": "label",
        "type": "uint8"
    }], "name": "addLabel", "outputs": [], "stateMutability": "nonpayable", "type": "function"
}, {
    ...
    "inputs": [], "name": "arbitrateOrders", "outputs": [{
        "components": [{"internalType": "uint256", "name": "id", "type": "uint256"}, {
            ...
            "name": "hcode",
            "type": "bytes32"
        }, {"internalType": "bytes", "name": "mcode", "type": "bytes"}, {
            "internalType": "uint256",
            "name": "deals",
            "type": "uint256"
    ...
    "inputs": [{"internalType": "string", "name": "tokenName", "type": "string"}, {
        ...
        "name": "unit",
        "type": "uint8"
    }, {"internalType": "string", "name": "information", "type": "string"}],
    "name": "businessBuy",
    "outputs": [],
    "stateMutability": "nonpayable",
    "type": "function"
    ...
    "inputs": [{"internalType": "string", "name": "tokenName", "type": "string"}, {
        ...
        "components": [{
            ...
            "components": [{"internalType": "address", "name": "owner", "type": "address"}, {
                ...
                "name": "information",
                "type": "string"
            }], "internalType": "struct Types.BusinessOrder", "name": "order", "type": "tuple"
        }, {"internalType": "string", "name": "name", "type": "string"}, {
            "internalType": "bytes32",
            "name": "hcode",
            "type": "bytes32"
    ...
    "outputs": [{"internalType": "bytes32", "name": "", "type": "bytes32"}, {
        ...
        "components": [{"internalType": "string", "name": "name", "type": "string"}, {
            ...
            "name": "userDeals",
            "type": "uint64"
        }, {"internalType": "uint64", "name": "businessDeals", "type": "uint64"}, {
            "internalType": "uint64",
            "name": "userRoleArbitrates",
            "type": "uint64"
        }, {"internalType": "uint64", "name": "businessRoleArbitrates", "type": "uint64"}, {
            "internalType": "uint8[]",
            "name": "labels",
            "type": "uint8[]"
        }], "internalType": "struct OTC.Kyc", "name": "", "type": "tuple"
    }],
    "stateMutability": "view",
    "type": "function"
}, {
    ...
    "inputs": [{"internalType": "uint256", "name": "id", "type": "uint256"}], "name": "orderInfo", "outputs": [{
        "components": [{"internalType": "uint256", "name": "id", "type": "uint256"}, {
            "internalType": "bytes32",
            "name": "hcode",
            "type": "bytes32"
            ...
            "name": "order",
            "type": "tuple"
        }], "internalType": "struct Types.RetUserOrder", "name": "ret", "type": "tuple"
    }], "stateMutability": "view", "type": "function"
}, {
    "inputs": [],
    "name": "owner",
    ...
    "inputs": [{"internalType": "uint256", "name": "_chargeRate", "type": "uint256"}],
    "name": "setChargeRate",
    "outputs": [],
    "stateMutability": "nonpayable",
    "type": "function"
