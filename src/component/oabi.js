...
const config = {
    name: "MAKT",
    contractAddress: "2Sw1CCrQtdNxeiBoVJrj8BLXaARP7DKw4uRD71uze4PdUmA4R2bXoJHHtPAaM2BCFZc1hNdVHHWJaTunMCf1ycvj",
...
class OAbi {
    ...
    chargeRate(from, callback) {
        let self = this;
        this.callMethod(contract, 'chargeRate', from, [], function (ret) {
            callback(20);
        });
    }
    ...
    setAuditor(pk, mainPKr, auditor, callback) {
        this.executeMethod(contract, 'setAuditor', pk, mainPKr, [auditor], "SERO", 0, callback);
    }

    setManager(pk, mainPKr, manager, flag, callback) {
        this.executeMethod(contract, 'setManager', pk, mainPKr, [manager, flag], "SERO", 0, callback);
    }
